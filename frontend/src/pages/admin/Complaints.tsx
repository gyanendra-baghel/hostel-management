            ...
            {complaints.length > 0 ? (
              complaints.map((c) => (
                <tr key={c._id} className="hover:bg-gray-50 transition-colors">
                  ...
                  <td className="px-6 py-4 text-sm text-gray-600 max-w-xs truncate" title={c.description}>
                    {c.description}
                  </td>
                  <td className="px-6 py-4">
                  ...
                  <td className="px-6 py-4 text-right">
                    {c.status !== 'resolved' ? (
                      <button
                        ...
                        className="text-white bg-green-600 hover:bg-green-700 px-3 py-1.5 rounded-md font-medium text-xs transition"
                      >
                        Resolve
                      </button>
                    ) : (
